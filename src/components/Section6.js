...
const Section6 = () => {
  return (
    <section class="section-2">
      <div class="rl_footer4_component">
        <div class="rl-padding-global-2">
          <div class="rl-container-large-2">
            <div class="rl-padding-section-medium">
              <div class="w-layout-grid rl_footer4_top-wrapper">
                <a
                  href="/"
                  id="w-node-b7e2aa59-8b28-5836-00f6-d5cacd3571f1-e4138a10"
                  class="rl_footer4_logo-link w-nav-brand"
                >
                  <img
                    ...
                    "
                    alt=""
                    class="rl_footer4_logo"
                  />
                </a>
                <div
                  id="w-node-b7e2aa59-8b28-5836-00f6-d5cacd3571f3-e4138a10"
                  class="w-layout-grid rl_footer4_link-list"
                >
                  <a
                    id="w-node-b7e2aa59-8b28-5836-00f6-d5cacd3571f4-e4138a10"
                    href="#"
                    class="rl_footer4_link"
                  >
                    Home
                  </a>
                  <a href="#" class="rl_footer4_link">
                    Services
                  </a>
                  <a href="#" class="rl_footer4_link">
                    Gallery
                  ...
                  <a
                    id="w-node-b7e2aa59-8b28-5836-00f6-d5cacd3571fc-e4138a10"
                    href="#"
                    class="rl_footer4_link"
                  >
                    Testimonial
                ...
                >
                  <a href="#" class="rl_footer4_social-link w-inline-block">
                    <div class="rl-social-icon w-embed">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                  ...
                  <a
                    href="https://www.instagram.com/goa.destinationweddings/"
                    class="rl_footer4_social-link w-inline-block"
                  >
                    <div class="rl-social-icon w-embed">
                      <svg
                        width="24"
              ...
              <div class="rl_footer4_spacing-block1"></div>
              <div class="rl_footer4_line-divider"></div>
              <div class="rl_footer4_spacing-block2"></div>
              <div class="w-layout-grid rl_footer4_bottom-wrapper">
                <div
                  id="w-node-b7e2aa59-8b28-5836-00f6-d5cacd35720d-e4138a10"
                  class="rl_footer4_credit-text"
                >
                  © 2022 Goa Destination Weddings. All right reserved.
                </div>
                <a href="#" class="rl_footer4_legal-link">
                  Privacy Policy
                </a>
                <a href="#" class="rl_footer4_legal-link">
                  Terms of Service
